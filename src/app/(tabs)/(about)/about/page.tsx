      ...
      <div className="w-[100%] mt-8">
        <article className="p-4 flex lg:flex-row flex-col items-center justify-center mb-5">
          <div className="flex flex-col justify-center items-center">
            <h1 className="text-6xl my-2 text-center underline underline-offset-8 decoration-solid w-[100%]">Quem Somos</h1>
            <p className="text-justify text-pretty indent-11 mx-10 text-2xl leading-relaxed w-[90%]">
          ...
          <Image
            ...
            className="ml-2 float-right mt-5 mr-5 object-none"
          />
        </article>
      </div>
