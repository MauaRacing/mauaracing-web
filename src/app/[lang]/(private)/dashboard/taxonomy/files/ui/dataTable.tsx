        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="bg-white">
            <div className="space-y-1">
              <Input
                placeholder="Filtrar Part Name..."
                value={(table.getColumn("part_name")?.getFilterValue() as string) ?? ""}
                onChange={(event) =>
                  table.getColumn("part_name")?.setFilterValue(event.target.value)
                }
                className="max-w-sm"
              />
              <Input
                placeholder="Filtrar Part Number..."
              ...
              />
              <Input
                placeholder="Filtrar tipo de arquivo..."
