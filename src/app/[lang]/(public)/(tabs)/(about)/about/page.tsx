        ...
        <section className="p-4 grid grid-cols-3 mb-5 gap-y-4">
          <div className="col-span-3 xl:col-span-2">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className={`mt-5 text-justify text-pretty md:indent-11 mx-10 text-2xl leading-relaxed w-[90%] ${figtree.className}`}>
                {dict.aboutGroup.about.mainText}
              </p>
            </div>
          </div>
          <div className="col-span-3 xl:col-span-1 m-auto mr-2">
            <div className="relative">
              <div className="bg-red-800 w-[95%] translate-x-8 translate-y-6 h-[95%] top-0 z-10 absolute"></div>
              <Image src={image2} width={1000} height={1000} alt="" className="relative z-20"/>
            </div>
          </div>
        </section>
      </div>
      ...
      <div className="mt-4 mb-10 w-[100%] flex justify-center items-center gap-10 flex-col xl:flex-row">
        <div className="relative">
          ...
          <Image
            ...
            height={400}
            alt=""
            className="ml-3 float-left relative z-20"
          />
        </div>
