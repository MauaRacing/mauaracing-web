    ...
    <nav className={className}>
      ...
      >
        ...
        >
          ...
          >
            {dict.navbar.fourthGroup.title.toUpperCase()}
            <ChevronDown className="ml-1 w-4" />
          </Link>
          ...
          <dialog
            open={openMedia}
            className={`${dialogColor} rounded-md min-w-32 w-10/12 lg:absolute relative`}
          >
            <div
            ...
            >
              ...
              <Link href={`/${lang}/`} className="border-b ">
                {dict.navbar.fourthGroup.firstOption}
              </Link>
              <Link href={`/${lang}/`} className="">
                {dict.navbar.fourthGroup.secondOption}
              </Link>
            </div>
          </dialog>
        </div>
