  ...
  return (
    <div className="flex mx-auto justify-center">
      ...
      <div className="bg-transparent border border-gray-800 rounded-xl w-[80%] h-[20%] p-3 ">
        <div className={`flex flex-col md:flex-row md:gap-y-3 md:gap-x-5 p-2 rounded-md ${alignment == "right"? "justify-end" : "justify-start"}`}>
...
export function CarCardDescription({children, alignment} : {children: ReactNode, alignment : String}){
  return(
    <div className={`w-fit md:text-balance md:text-pretty text-wrap`}>
      {children}
    </div>
  )
}
